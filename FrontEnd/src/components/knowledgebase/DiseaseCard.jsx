    ...
    <div className="max-w-sm rounded-lg bg-darkbg overflow-hidden shadow-lg text-white">
      <Link to={`/disease/${disease._id}`}>
        ...
        <div className="px-6 py-4">
          ...
          <p className="text-gray-300 mb-2 font-bold">Affected Crops: 
          ...
          <p className="text-gray-300 mb-2 font-bold">Disease Type:
            <span className="text-gray-400 font-normal"> {disease.diseaseType}</span>
          </p>
          <p className="text-gray-300 mb-2 font-bold">Disease Status:
