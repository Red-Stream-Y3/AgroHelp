...
const Crop = () => {
  ...
  return (
    <div>
      ...
      {/* desktop view */}
      <div className="hidden md:block bg-darkbg text-white overflow-hidden mx-auto">
    ...
    {crop.cropInfo && (
    <div className="bg-lightbg text-white overflow-hidden mx-auto">
      <div className="py-4 px-6">
        <h1 className="text-xl font-semibold mb-3">Crop Climate </h1>
        <p className="text-gray-300 leading-relaxed mb-3">{crop.cropInfo.climate}</p>
        <h1 className="text-xl font-semibold mb-3">Crop Season </h1>
        <p className="text-gray-300 leading-relaxed mb-3">{crop.cropInfo.season}</p>
        <h1 className="text-xl font-semibold mb-3">Seed Type </h1>
        <p className="text-gray-300 leading-relaxed mb-3">{crop.cropInfo.seedType}</p>
        <h1 className="text-xl font-semibold mb-3">Soil Type </h1>
        <p className="text-gray-300 leading-relaxed mb-3">{crop.cropInfo.soil}</p>
        <h1 className="text-xl font-semibold mb-3">Field Preparation </h1>
        <p className="text-gray-300 leading-relaxed mb-3">{crop.cropInfo.fieldPreparation}</p>
        <h1 className="text-xl font-semibold mb-3">Fertilizer </h1>
        <p className="text-gray-300 leading-relaxed mb-3">{crop.cropInfo.fertilizer}</p>
        <h1 className="text-xl font-semibold mb-3">Irrigation </h1>
        <p className="text-gray-300 leading-relaxed mb-3">{crop.cropInfo.irrigation}</p>
        <h1 className="text-xl font-semibold mb-3">Weed Control </h1>
        <p className="text-gray-300 leading-relaxed mb-3">{crop.cropInfo.weedControl}</p>
        <h1 className="text-xl font-semibold mb-3">Pest Control </h1>
        <p className="text-gray-300 leading-relaxed mb-3">{crop.cropInfo.pestControl}</p>
        <h1 className="text-xl font-semibold mb-3">Harvesting </h1>
        <p className="text-gray-300 leading-relaxed mb-3">{crop.cropInfo.harvesting}</p>
        <h1 className="text-xl font-semibold mb-3">Yield </h1>
        <p className="text-gray-300 leading-relaxed mb-3">{crop.cropInfo.yield}</p>
        <h1 className="text-xl font-semibold mb-3">Storage </h1>
        <p className="text-gray-300 leading-relaxed mb-3">{crop.cropInfo.storage}</p>
        <h1 className="text-xl font-semibold mb-3">Other Information </h1>
        <p className="text-gray-300 leading-relaxed mb-3">{crop.otherInfo}</p>
      </div>
    </div>
    )}
    </div>
